...
- self-driving cars
- where is meaningful economy impact?
:::
...
![Autoencoders: encode (compress) information automatically. Everything up to the middle is called the encoding part, everything after the middle the decoding and the middle the code.](img/ae.png)
...
![](img/scale_is_all_you_need.png){height=500}
:::
...
Book screenshots used:

- Understanding Computers (Artificial Intelligence). Time-Life books
