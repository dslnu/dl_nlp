...
CHECKPOINT_PATH = "./_saved_models/tutorial4"
...
$$
```{=html}
<iframe width="1920" height="1080" src="./_resources/dl_optimization.html" title="Optimization"></iframe>
```
...
:::
```{=html}
<iframe width="1920" height="1080" src="./_resources/dl_rastrigin.html" title="Optimization"></iframe>
```
## Optimization {.smaller}
:::{.callout-tip icon=false}
## Rosenbrock function
...
:::
```{=html}
<iframe width="1920" height="1080" src="./_resources/dl_rosenbrock.html" title="Optimization"></iframe>
```
