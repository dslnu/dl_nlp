...
CHECKPOINT_PATH = "./_saved_models/tutorial5"
...
%tensorboard --logdir ./_saved_models/tutorial5/tensorboards/GoogleNet/
```
:::
...
%tensorboard --logdir ./_saved_models/tutorial5/tensorboards/ResNet/
```
:::
...
```python
# Opens tensorboard in notebook. Adjust the path to your CHECKPOINT_PATH!
%tensorboard --logdir ./_saved_models/tutorial5/tensorboards/DenseNet/
```
:::
